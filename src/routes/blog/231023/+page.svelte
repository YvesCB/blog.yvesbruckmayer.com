<article>
	...
	<h2>Walking</h2>
	<p>
		If there is one change in my body from my time in the military, it's not any
	...
	<p>
		Walking is nice. I've always quite liked walking and being out in nature.
		...
		stimulation. Still, walking is nice.
	</p>

	<h2>Might as well</h2>
	<p>
		I live in Switzerland and even as someone who has spent his whole life in
	...
	<p>
		It is fantastic how easy it is here to just "go for a walk". People in
		...
		are very easy to navigate thanks to clear signage. More on that later.
	</p>

	<h2>Give me a sign!</h2>
	<p>
		I already quickly brought up signs but I want to go into a little bit more
		...
		walking along a trail and have not strayed of the path.
	</p>
	...
	<img
		src="/blogimg/231023_img/sign.jpg"
		alt="trail marking sign"
		class="landscape blog-img"
	/>
	<p>This one here shows the path taking a turn.</p>
	<img
		src="/blogimg/231023_img/arrowsign.jpg"
		alt="trail marking sign with arrows showing direction"
		class="landscape blog-img"
	/>
	<p>
		Lastly one that is like the first, but here just painted on a tree in the
		forest.
	</p>
	<img
		src="/blogimg/231023_img/treemarking.jpg"
		alt="trail marking sign on tree"
		class="landscape blog-img"
	/>

	<h2>Departure</h2>
	<p>
		Sunday the 22nd of October, 9AM. I get up! Having picked out my route and
		...
		my backpack and go outside.
	</p>
	<p>
		The route that I picked is a bit over 12km and I plan to be out for about 4h
		total. That leaves me with more than enough time for the distance as well as
		the included lunch break.
	</p>
	<p>
		Soon after I get to the trail, I'm already met with quite a nice path that
		crosses a field. I'm still getting familiar with the area and it's always
		nice to find new spots.
	</p>
	<img
		src="/blogimg/231023_img/fieldpath.jpg"
		alt="trail marking sign on tree"
		class="landscape blog-img"
	/>

	<h2>Entering the forest and lunch</h2>
	<p>
		After about 30min of walking, I enter the forest. The trail up until this
		...
		perfect temperature for walking as far as I'm concerned.
	</p>
	<p>
		I make it to my intended lunch spot at around 11:40AM. Originally I thought
	...
	<img
		src="/blogimg/231023_img/lunch.jpg"
		alt="trail marking sign on tree"
		class="portrait blog-img"
	/>

	<h2>The way back and losing to the fear of blisters</h2>
	<p>
		After lunch, I get on my way to continue on the trail. Having walked just
		...
		with my current foot situation but I manage it.
	</p>
	<p>
